...
class LHRS extends Component {
  ...
  _getLHRSVersions = () => {
    ...
    helpers.getJSON(apiUrl, (result) => {
      ...
      result.forEach((version) => {
        const obj = {
          label: version.lhrs_version_title,
          value: version.lhrs_version,
        };
        items.push(obj);
      });
  ...
  updateLHRSActions = (pointObj) => {
    const optionalItem = {
      label: "Enter Distance from Point A",
      value: "enterDistanceFromA",
    };
        ...
        <div className="sc-lhrs-container">
          <div className="sc-container">
            ...
            <div className="sc-lhrs-row sc-arrow">
              ...
              <span>
                <input
                  id="sc-lhrs-snapping-distance-select"
                  type="text"
            ...
            <div className="sc-container">
              ...
              <LHRSInputRow
                label={this.state.inputALabel}
                value={this.state.inputAValue}
                onChange={(evt) => {
                  this.setState({ inputAValue: evt.target.value });
                }}
                onFocus={(evt) => {
              ...
              />
              <LHRSInputRow
                label={this.state.inputBLabel}
                value={this.state.inputBValue}
                onChange={(evt) => {
                  this.setState({ inputBValue: evt.target.value });
                }}
                onFocus={(evt) => {
                  helpers.disableKeyboardEvents(true);
                }}
